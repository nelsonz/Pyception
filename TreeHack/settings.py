# Django settings for TreeHack project.
import socket
import os
#hello

SITE_ROOT = os.path.realpath(os.path.dirname(__file__))
MEDIA_ROOT = STATIC_DOC_ROOT = os.path.join(SITE_ROOT, 'assets')
MEDIA_URL = '/assets/'
...
SECRET_KEY = 'rome@21+0#cmjudk_0e9z@t-#l3yo)2u7qg1i62#g@13ia3pp*'
